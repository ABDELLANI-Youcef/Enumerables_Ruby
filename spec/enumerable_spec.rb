...
describe Enumerable do
  describe '#my_each' do
    ...
    it 'should print the elements in the array of strings' do
      expect { %w[hello World Ramin Youcef].my_each { |x| puts x } }.to output("hello\nWorld\nRamin\nYoucef\n").to_stdout
    end
  end
  describe '#my_each_with_index' do
    ...
    it 'should print the elements in the array of strings with their indexes' do
      expect { %w[hello World Ramin Youcef].my_each_with_index { |x, index| puts x.to_s + ' ' + index.to_s } }.to output("hello 0\nWorld 1\nRamin 2\nYoucef 3\n").to_stdout
    end
  end
  ...
  describe '#my_select' do
    ...
    it 'shoult return an array containing the strings that are less than 4' do
      expect(%w[ramin and youcef are working here].my_select { |x| x.size < 4 }).to eql(%w[and are])
    end
  end
  ...
  describe '#my_inject' do
    ...
    it 'should return the product of all the numbers in the array which is 151200' do
      expect([5, 6, 7, 8, 9, 10].my_inject(:*)).to eql 151_200
    end
